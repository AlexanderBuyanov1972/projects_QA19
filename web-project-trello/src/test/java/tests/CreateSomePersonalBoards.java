...
public class CreateSomePersonalBoards extends TestBase {
    int numberPersonalBoards = 5;
...
//
//        for (int i = 0; i < numberPersonalBoards; i++) {
...
//        Assert.assertEquals(after, before + numberPersonalBoards);
    }
}
